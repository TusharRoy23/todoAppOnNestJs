...
export class Init1610216876650 implements MigrationInterface {
    name = 'Init1610216876650'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "salt" character varying NOT NULL, "userInfoId" integer, CONSTRAINT "REL_5c634c605ff93c4ac0f1be62f0" UNIQUE ("userInfoId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
